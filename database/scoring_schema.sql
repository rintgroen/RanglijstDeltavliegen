...
CREATE TABLE IF NOT EXISTS rankings_scoring_tasks (
  ...
  jump_the_gun_enabled TINYINT(1) NOT NULL DEFAULT 1,
  jump_the_gun_seconds_per_point DECIMAL(6,2) NOT NULL DEFAULT 2.00,
  jump_the_gun_max_seconds INT UNSIGNED NOT NULL DEFAULT 300,
...
CREATE TABLE IF NOT EXISTS rankings_scoring_task_turnpoints (
  ...
  control_zone_type VARCHAR(20) NOT NULL DEFAULT 'cylinder',
  line_orientation_deg DECIMAL(6,2) DEFAULT NULL,
  line_offset_km DECIMAL(8,3) NOT NULL DEFAULT 0.000,
  line_half_length_km DECIMAL(8,3) NOT NULL DEFAULT 1.000,
  goal_line_length_m INT UNSIGNED NOT NULL DEFAULT 400,
